...
class SurveyTest extends PHPUnit_Framework_TestCase {
	...
	function testSurveyFunction() {
		...
		$accountSettingForm->findElement ( WebDriverBy::id ( "SurveyCreator_first_name" ) )->clear()->sendKeys ( "My First Name" );
		$accountSettingForm->findElement ( WebDriverBy::id ( "SurveyCreator_last_name" ) )->clear()->sendKeys ( "My Last Name" );
